...
class BasicAgent:
    ...
    def __init__(self, vehicle, target_speed=20, opt_dict={}, map_inst=None, grp_inst=None):
        ...
        # Last full output of GlobalRoutePlanner.trace_route (for visualization / debugging)
        self._last_global_route = []
        self._global_route_revision = 0
    ...
    def set_destination(self, end_location, start_location=None, clean_queue=True):
        ...
        if clean_queue:
            self._last_global_route = list(route_trace)
        else:
            self._last_global_route = self._last_global_route + list(route_trace)
        self._global_route_revision += 1
    ...
    def set_global_plan(self, plan, stop_waypoint_creation=True, clean_queue=True):
        ...
        """
        if clean_queue:
            self._last_global_route = list(plan)
        else:
            self._last_global_route = self._last_global_route + list(plan)
        self._global_route_revision += 1
