...
class World(object):
    def __init__(self, carla_world, hud, args):
        ...
        self.planner_agent = None  # set in game_loop when --mode agent
        self._global_route_debug_drawn_revision = -1
        self._global_route_debug_agent_id = None
    ...
    def restart(self):
        ...
        while self.player is None:
            ...
            self.modify_vehicle_physics(self.player)
        # Set up the sensors.
        self.collision_sensor = sensors.CollisionSensor(self.player, self.hud)
        self.lane_invasion_sensor = sensors.LaneInvasionSensor(self.player, self.hud)
        self.gnss_sensor = sensors.GnssSensor(self.player)
        self.imu_sensor = sensors.IMUSensor(self.player)
        self.camera_manager = sensors.CameraManager(self.player, self.hud, self._gamma)
    ...
    def toggle_radar(self):
        if self.radar_sensor is None:
            self.radar_sensor = sensors.RadarSensor(self.player)
